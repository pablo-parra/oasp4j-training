INSERT INTO RestaurantTable (id, modificationCounter, number, state) VALUES (101, 1, 1, 1);
...
INSERT INTO StaffMember (id, modificationCounter, role, login, firstname, lastname) VALUES (4, 0, 4, 'manager', 'Jason', 'Smith');